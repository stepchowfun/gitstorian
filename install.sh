...
(
  ...
  DESTINATION="${PREFIX:-/usr/local/bin}/gitstorian"
  ...
  # Download the binary.
  curl \
    "https://github.com/stepchowfun/gitstorian/releases/download/$RELEASE/$FILENAME" \
